<%--
  Howto / References page. Wraps shared header + footer from
  Globals.java so it inherits the same banner, CSS, and config-driven
...
<ol>
	<li>Start&nbsp;by&nbsp;selecting the&nbsp;<a
		href="${pageContext.request.contextPath}/MRGridServlet">NMR
	...
	table. A&nbsp;<a href="readme.jsp">README</a> and index file will also
...
<ul>
	...
	database </b>(<a href="#Doreleijers_J.F._Mading_S">ref 1</a>)<b>.</b><br><ol>
		<li>Start&nbsp;by&nbsp;selecting the&nbsp;<a
			href="${pageContext.request.contextPath}/MRGridServlet">NMR
		Restraints Grid</a> so that the default options are used.</li>
		...
		please don't use them for future reference.&nbsp;A&nbsp;<a
			href="readme.jsp">README</a> and index file will also be included in
		the download.</li>
...
<p><a href="http://code.google.com/p/nmrrestrntsgrid/wiki/FindNumberOfRestraintsPerResidue">Find the
...
directory of choice on your computer. The uncompressed files will a <a
	href="readme.jsp">README</a> that explains how to use the downloaded
data.</p>
...
<ul>
	<li><a href="${pageContext.request.contextPath}/MRGridServlet">Top
	level</a></li>
	<li><a
		href="${pageContext.request.contextPath}/MRGridServlet?bmrb_id=4010&amp;min_items=0">Individual
	entry</a> (E.g. BMRB id 4010)</li>
	<li><a
		href="${pageContext.request.contextPath}/MRGridServlet?pdb_id=1xmw&amp;min_items=0">Individual
...
<p>A database dump in text format is made&nbsp;<a
	href="https://bmrb.io/servlet_data/viavia/mr_mysql_backup">available</a>
...
The links between BMRB and PDB entries are based on the file&nbsp;<span
	...
	href="https://bmrb.io/servlet_data/viavia/bmrb_pdb_match">available</a>.
...
<ul>
	<li><a
		href="https://bmrb.io/servlet_data/molgrap/pic/xm/1xmw_xl.gif">Individual
	entry</a> (E.g. PDB code&nbsp;1XMW)</li>
	<li><a href="https://bmrb.io/servlet_data/molgrap">Indexed
	by BMRB id</a></li>
	<li><a
		href="https://bmrb.io/servlet_data/molgrap/index/index_pdb.html">Indexed
	by PDB id&nbsp;</a><small>NEW</small></li>
</ul>

<h2><a name="Known_bugs_and_todo_list"></a>Known bugs and todo list</h2>

<p>Please check the issues list at Google Code <a href="http://code.google.com/p/nmrrestrntsgrid/issues/list">here</a>.</p>

<h2><a name="NMR_data_format_descriptions"></a>NMR data format
descriptions</h2>

<p>The formats and how they are converted are described in&nbsp;<a
	href="http://nmr.cmbi.ru.nl/~jd/wattos/">Wattos</a> Java documentation for
Amber, Discover, Dyana, Emboss, and Xplor.</p>
...
from&nbsp;<a href="http://nmr.cmbi.ru.nl/~jd/wattos/">Wattos</a> home
page.</p>
...
a collaborative project involving individuals from the:</p>
...
<ul>
	...
	<li><a href="http://nmr.cmbi.ru.nl">Proteins Biophysics</a>, IMM, (Radboud University Nijmegen, the Netherlands),</li>
	<li><a href="http://www.ccpn.ac.uk/">CCPN</a>, and</li>
	<li><a href="http://www.ebi.ac.uk/msd-srv/docs/NMR/main.html">PDBe</a>, Protein Data Bank Europe, (Hinxton,
	United Kingdom).&nbsp;</li>
</ul>
...
<p>The software packages <a
	href="http://webapps.ccpn.ac.uk/fcweb/">
FormatConverter</a> and <a href="https://bmrb.io/wattos/">Wattos</a>
...
<ol>
	...
	REfined solution NMR structures. Proteins 55, 483-486. <a
		href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&amp;db=PubMed&amp;list_uids=15103611&amp;dopt=Abstract">medline</a></li>
</ol>
...
<table>
	<tbody>
		<tr>
			<td align="left"><a href="https://bmrb.io/"><img
				src="../images/BMRB_ICON_SHORT_TEXT.svg" alt="BMRB"
				style="height: 80px; width: auto;" border="0"></a></td>
			<td><b>BMRB</b>: grant LM05799 from the National Library of
			Medicine, NIH</td>
		</tr>
		<tr>
			<td><a href="http://nmr.cmbi.ru.nl"><img src="../images/proteinDynamics.png" border="0" width="150" ></a></td>
			<td><b>Proteins Biophysics</b>, IMM/CMBI, Radboud University Nijmegen, the Netherlands</td>
		</tr>
		<tr>
			<td><a href="http://www.ccpn.ac.uk/"><img
				src="../images/ccpnLogo.png" border="0"></a></td>
		...
		<tr>
			...
			QLG2-CT-2000-01313 and <br>EU FP6<b> 'ExtendNMR'</b></td>
		</tr>
	</tbody>
</table>
